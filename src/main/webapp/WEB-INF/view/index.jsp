	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner" style="width: 100%">
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="resources/images/carousel-6.jpeg" alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="resources/images/carousel-4.jpeg" alt="Third slide">
			</div>
		</div>
       ...
       <div class="row">
         <div class="col-md-2 " >
             <div class="list-group mt-4">
                 ...
                 <a href="category?categoryId=0" class="list-group-item list-group-item-action active"  style="background-color: #FA8072" ><span class="text-color">All Categories</span></a>
               <%
