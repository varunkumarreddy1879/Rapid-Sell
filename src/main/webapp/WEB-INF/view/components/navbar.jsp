<%@ page import ="com.rapidesell.model.*"%>
<%@ page import="com.rapidesell.utility.*"%>
<%@ page import="com.rapidesell.dao.*"%>
...
<div class="container-fluid">
  <img src="resources/images/mainlogo.png" width="55" height="55" class="d-inline-block align-top" alt="">
  <a class="navbar-brand" href="/"><h3 class="text-color"><i>Rapid sell</i></h3></a>
